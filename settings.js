...
creator = 'Galang Purnama' // Nama 
port = 8080 //port host
LimitApikey = 200 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = 'mongodb+srv://nekohimebot:3xMkC439PoGatVfC@cluster0.qaphew1.mongodb.net/?retryWrites=true&w=majority' //example "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
sendemail = 'nekohime.bot@gmail.com' //Email SMTP
fromsendemail = 'nekohime.bot@gmail.com' // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = 'node:8080' // Password Email SMTP
domain = 'nekohimeapi.my.id'// domain website tanpa http or https
...
recaptcha_key_1 = '6LdzRD0mAAAAAKoOExmY31BkCo5lBToF0dFTVurS', 
recaptcha_key_2 = '6LdzRD0mAAAAANhYWKAtWg4EjkUn2P5q-NJsCDnD'
